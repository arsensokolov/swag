...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/arsensokolov/swag/v2/testdata/global_override/types.Application":  "string",
		"github.com/arsensokolov/swag/v2/testdata/global_override/types.Application2": "github.com/arsensokolov/swag/v2/testdata/global_override/othertypes.Application",
		"github.com/arsensokolov/swag/v2/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag/gen"))

	parser = New(SetPackagePrefix("github.com/arsensokolov/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/arsensokolov/swag/gen"))

	parser = New(SetPackagePrefix("github.com/arsensokolov/swag/cmd,github.com/arsensokolov/swag/gen"))
